...
from .code_execution_hardening import attach as attach_code_execution_hardening
from .workflow_hardening import attach as attach_workflow_hardening
...
attach_code_execution_hardening(app,_require,agent,registry,settings)
workflow_engine=attach_workflow_hardening(app,_require,agent,jobs,store)
