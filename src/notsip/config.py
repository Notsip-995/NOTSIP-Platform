...
class Settings(BaseSettings):
    ...
    voice_enabled:bool=False; native_voice_enabled:bool=False; voice_sample_rate:int=16000; vad_rms_threshold:float=700; vad_silence_blocks:int=8; wake_word:str=''
    ...
    log_level:str='INFO'; log_max_bytes:int=10485760; log_backup_count:int=5; open_browser:bool=True; node_name:str='NOTSIP'
